...
class MicroPatientPhoto extends StatefulWidget {
  @override
  _MicroPatientPhotoState createState() => _MicroPatientPhotoState();
}

class _MicroPatientPhotoState extends State<MicroPatientPhoto> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Align(
                          ...
                          child: Text(
                            "I hereby consent to and authorize the use by Bombay Salon & Spa of the specified microblading photographs and/or video; that is, photographs taken before, during and after my microblading procedure. \n\nI understand that my identity will be protected and neither my full face nor my name will be used in conjunction with the photographs and/or video. \n\nBombay Salon & Spa has explained that all the photos and/or videos will be clinically appropriate and tastefully presented.\n\nI have agreed on the photographs that Bombay Salon & Spa requests to be used and it is understood that these photos may be used on Bombay Salon & Spa’s web site, social media accounts (Facebook, Instagram, Twitter), and in-office for demonstrational and promotional purposes. I understand that I am not entitled to compensation for these photos being used.\n\nShould I desire to revoke permission for their use in the future, I understand that I must notify Bombay Salon & Spa in writing and allow 30 days to accomplish this removal.\n\nI now release Bombay Salon & Spa, and anyone authorized by Bombay Salon & Spa, all personal rights and objections I have or may have to the above described uses of my photographs and/or videos. I have entered into this release freely or voluntarily and agree to be bound thereby.",
                            style: TextStyle(
                              fontSize: 18.0,
                            ),
                          ),
